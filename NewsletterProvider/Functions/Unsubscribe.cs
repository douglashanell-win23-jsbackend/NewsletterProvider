            ...
            if (!string.IsNullOrEmpty(body))
            {
                ...
                if (subscribeEntity != null)
                {
                    ...
                    if (existingSubscriber != null)
                    {
                        ...
                        return new OkObjectResult(new { Status = 200, Message ="You're now unsubscribed." });
                    }
                }
            }
            return new BadRequestObjectResult(new { Status = 400, Message = "Unable to unsubscribe, try again later." });
        }
    }
}
